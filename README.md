# Deep mutational scanning of H5N1 influenza haemagglutinin using a barcoded lentiviral platform (strain A/American Wigeon/South Carolina/USDA-000345-001/2021) and entry in NeuGc vs NeuAc expressing cells
This repository has the code and data for mapping effects of mutations to H5 HA on binding NeuAc versus NeuGc containing sialic acids.
For rendering of key results and an easy-to-interpret summary, see the documentation of the analysis at [https://github.com/dms-vep/Flu_H5_American-Wigeon_South-Carolina_2021-H5N1_DMS_NeuGc](https://dms-vep.org/Flu_H5_American-Wigeon_South-Carolina_2021-H5N1_DMS_NeuGc/)
